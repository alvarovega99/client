...
export function loginUser(payload) {
    return async (dispatch) => {
        try {
            var json = await axios.post('http://localhost:3001/usuarios/loginUser', payload);
            return dispatch({
                type: LOGIN_USER,
                payload: json.data,
            });
...
export function eliminarProductos(data) {
    return async function (dispatch) {
        const res =  await axios.post('http://localhost:3001/productos/delete', data);
        dispatch({
...
export function eliminarUbicacion(data) {
    return async function (dispatch) {
        const res =  await axios.post('http://localhost:3001/ubicaciones/delete', data);
        dispatch({
...
export function ingresarOperacion(data) {
    return async function (dispatch) {
        const res =  await axios.post('http://localhost:3001/operaciones', data);
        dispatch({
...
export function buscarCodigo(data) {
    return async function (dispatch) {
        const res =  await axios.get(`http://localhost:3001/operaciones/${data.codigoCarga}`);
        dispatch({
            type: GET_LOTE,
            payload: res.data
        })
...
export function getUbicaciones() {
    return async function (dispatch) {
        const res =  await axios.get('http://localhost:3001/ubicaciones');
        dispatch({
...
export function getOperaciones() {
    return async function (dispatch) {
        const res =  await axios.get('http://localhost:3001/operaciones');
        dispatch({
...
export function getTotalGalleta() {
    return async function (dispatch) {
        const res =  await axios.get('http://localhost:3001/operaciones/galleta/total');
        dispatch({
...
export function getTotalPolvo() {
    return async function (dispatch) {
        const res =  await axios.get('http://localhost:3001/operaciones/polvo/total');
        dispatch({
...
export function getTotalGalletaID(id) {
    return async function (dispatch) {
        const res =  await axios.get(`http://localhost:3001/operaciones/galleta/id/${id}`);
        dispatch({
...
export function getTotalPolvoID(id) {
    return async function (dispatch) {
        const res =  await axios.get(`http://localhost:3001/operaciones/polvo/id/${id}`);
        dispatch({
...
export function postUbicaciones(name){
    return async function (dispatch) {
        const res =  await axios.post('http://localhost:3001/ubicaciones', name);
        dispatch({
...
export function postProductos(name){
    return async function (dispatch) {
        const res =  await axios.post('http://localhost:3001/productos', name);
        dispatch({
            type: POST_PRODUCTOS,
            payload: res.data
        })
...
export function postUsuario(name){
    return async function (dispatch) {
        const res =  await axios.post('http://localhost:3001/usuarios', name);
        dispatch({
            type: POST_USUARIOS,
            payload: res.data
        })
...
export function postSalida(obj){
    return async function (dispatch) {
        const res =  await axios.post('http://localhost:3001/operaciones/status', obj);
        dispatch({
            type: POST_SALIDA,
            payload: res.data
        })
